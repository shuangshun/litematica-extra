...
package dev.shun.litematica.extra.api;

import fi.dy.masa.litematica.schematic.SchematicMetadata;

public interface ISchematicMetadata {

    int getSchematicVersion();
    void setSchematicVersion(int version);

    int getMinecraftDataVersion();
    void setMinecraftDataVersion(int version);

    String getFileType();
    void setFileType(String type);

    static ISchematicMetadata of(SchematicMetadata meta) {
        return (ISchematicMetadata) meta;
    }
}